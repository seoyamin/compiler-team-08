...
param_dcl 			: dcl_spec declarator									{semantic(22);}
					| dcl_spec error										{yyerrok; printerror("param_dcl_no_declarator\n");};
compound_st 		: TLEFTBRACE TRIGHTBRACE								{semantic(231);}
					| TLEFTBRACE error										{yyerrok; printerror("compound_st", NO_RIGHTBRACE);}
					| TLEFTBRACE declaration_list TRIGHTBRACE				{semantic(232);}
					| TLEFTBRACE declaration_list error		 			{yyerrok; printerror("compound_st", NO_RIGHTBRACE);}
					| TLEFTBRACE statement_list TRIGHTBRACE				{semantic(233);}
					| TLEFTBRACE statement_list error						{yyerrok; printerror("compound_st", NO_RIGHTBRACE);}
					| TLEFTBRACE declaration_list statement_list TRIGHTBRACE	{semantic(233);}
					| TLEFTBRACE declaration_list statement_list error		{yyerrok; printerror("compound_st", NO_RIGHTBRACE);};
...
declarator 			: TIDENT												{printf("TIDENT : %s \n", identStr); defineIdentType("integer scalar variable", identStr); semantic(33);}
					...
					//| TIDENT TLEFTBRACKET error TRIGHTBRACKET 			{yyerrok; printerror("declarator", NO_NUM);}
					| TIDENT TLEFTBRACKET error								{yyerrok; printerror("declarator", NO_RIGHTBRACKET);};
...
return_st 			: TRETURN TSEMI											{semantic(52);}								// return;의 경우	
					...
					| TRETURN expression error								{yyerrok; printerror("return_st_no_semi\n");}  // return 3의 경우 -> no semi
					| TRETURN error											{yyerrok; printerror("return_st_no_return_val\nreturn_st_no_semi\n");};  // return 의 경우 -> no return value + no semi
...
assignment_exp 		: logical_or_exp										{semantic(54);}
					...
					| unary_exp TASSIGN error						{yyerrok; printerror("assignment_exp_no_right_assignment_exp_assign\n");}
					| unary_exp TADDASSIGN error					{yyerrok; printerror("assignment_exp_no_right_assignment_exp_addassign\n");}
					| unary_exp TSUBASSIGN error					{yyerrok; printerror("assignment_exp_no_right_assignment_exp_subassign\n");}
					| unary_exp TMULASSIGN error					{yyerrok; printerror("assignment_exp_no_right_assignment_exp_mulassign\n");}
					| unary_exp TDIVASSIGN error			 		{yyerrok; printerror("assignment_exp_no_right_assignment_exp_divassign\n");}
					| unary_exp TMODASSIGN error				 	{yyerrok; printerror("assignment_exp_no_right_assignment_exp_modassign\n");};

logical_or_exp 		: logical_and_exp										{semantic(61);}
					| logical_or_exp TOR logical_and_exp 					{semantic(62);}
					| logical_or_exp TOR error								{yyerrok; printerror("logical_or_exp_no_right");};

logical_and_exp 	: equality_exp											{semantic(63);}
		 			| logical_and_exp TAND equality_exp 					{semantic(64);}
					| logical_and_exp TAND error								{yyerrok; printerror("logical_and_exp_no_right");};
...
equality_exp 		: relational_exp										{semantic(65);}
					...
					| equality_exp TEQUAL error								{yyerrok; printerror("equality_exp_no_right_EQU");}
					| equality_exp TNOTEQU error							{yyerrok; printerror("equality_exp_no_right_NOTEQU");};
relational_exp 		: additive_exp 											{semantic(68);}
					...
					| relational_exp TGREAT	error				 			{yyerrok; printerror("relational_exp_no_right_great");}
					| relational_exp TLESS error							{yyerrok; printerror("relational_exp_no_right_less");}
					| relational_exp TGREATE error							{yyerrok; printerror("relational_exp_no_right_greate");}
					| relational_exp TLESSE error							{yyerrok; printerror("relational_exp_no_right_lesse");};
additive_exp 		: multiplicative_exp									{semantic(73);}
					...
					| additive_exp TADD	error								{yyerrok; printerror("additive_exp_no_right_add");}
					| additive_exp TSUB error					 			{yyerrok; printerror("additive_exp_no_right_sub");};
multiplicative_exp 	: unary_exp												{semantic(76);}
					...
					| multiplicative_exp TMUL error			 					{yyerrok; printerror("multiplicative_exp_no_right_mul");}
					| multiplicative_exp TDIV error								{yyerrok; printerror("multiplicative_exp_no_right_div");}
				 	| multiplicative_exp TMOD error								{yyerrok; printerror("multiplicative_exp_no_right_mod");};
